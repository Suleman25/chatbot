-- ============================================================================
-- FINAL FIXED ADMIN SETUP FOR sulemanjamil177@gmail.com
-- ============================================================================
-- This script fixes all ambiguous column reference errors
...
BEGIN
    ...
    -- Create profile if it doesn't exist (FIXED: use explicit table reference)
    INSERT INTO public.profiles (user_id, display_name, created_at, updated_at)
    VALUES (found_user_id, split_part(target_email, '@', 1), NOW(), NOW())
    ON CONFLICT (public.profiles.user_id) DO NOTHING;
...
AS $$
BEGIN
    -- Create profile for new user (FIXED: use explicit table reference)
    INSERT INTO public.profiles (user_id, display_name, created_at, updated_at)
    VALUES (
        NEW.id, 
