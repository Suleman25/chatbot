-- ============================================================================
-- QUICK SUGGESTIONS FIX
-- ============================================================================
-- This script will quickly fix the suggestions functionality
-- without clearing existing data
-- ============================================================================

-- Step 1: Ensure all users are in profiles table (without clearing existing data)
...
-- Step 3: Ensure friends table exists
...
-- Step 4: Create indexes for friends table if they don't exist
CREATE INDEX IF NOT EXISTS idx_friends_user_id ON public.friends(user_id);
CREATE INDEX IF NOT EXISTS idx_friends_friend_id ON public.friends(friend_id);
CREATE INDEX IF NOT EXISTS idx_friends_status ON public.friends(status);

-- Step 5: Fix RLS policies for friends table
...
-- Step 6: Add sample friend relationships only if they don't exist
...
-- Step 8: Test suggestions query
SELECT 'Test: Suggestions for sam (admin)' as test_name;
SELECT 
    p.user_id,
    p.display_name,
    p.avatar_url
