-- ============================================================================
-- FIXED ADMIN SETUP FOR sulemanjamil177@gmail.com
-- ============================================================================
-- This script first fixes the profiles table, then makes the user admin
...
-- Step 11: Create function to assign admin role (fixed version)
