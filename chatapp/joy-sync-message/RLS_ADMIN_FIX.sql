-- ============================================================================
-- RLS ADMIN FIX - Fix Row Level Security Policies
-- ============================================================================
-- Fix RLS policies to allow admin role assignment
-- Run this in Supabase SQL Editor
-- ============================================================================

-- Step 1: Drop existing user_roles table to recreate with proper policies
...
-- Step 4: Create PERMISSIVE policies (allow more access)
...
-- Step 11: Make the user an admin (should work now with permissive policies)
